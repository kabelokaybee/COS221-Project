    ...
    <div class="mainContainer">
        ...
        <div class="container">
            ...
            <div class="clearfix">
                ...
                <button id = "btnSignUp" type="submit" name="submit" class="signupbtn" onclick="return overallValidate()">Update Wine</button>
...
<script src="js/updateWinery.js" type = "text/javascript"></script>
